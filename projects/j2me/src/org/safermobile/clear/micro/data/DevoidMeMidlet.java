...
public class DevoidMeMidlet extends MIDlet implements Runnable, CommandListener {
	...
	{
	 	List listContacts = new List("DevoidME [Contacts]", List.IMPLICIT);
